    ...
    for(let i=0; i<Necesidades.Necesidades0.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades0[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          ...
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades0[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
    ...
    for(let i=0; i<Necesidades.Necesidades1.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades1[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades1[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades2.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades2[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades2[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades3.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades3[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades3[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades4.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades4[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades4[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades5.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades5[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades5[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades6.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades6[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades6[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades7.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades7[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades7[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades8.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades8[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades8[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades9.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades9[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades9[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades10.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades10[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades10[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades11.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades11[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades11[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades12.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades12[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades12[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades13.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades13[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades13[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades14.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades14[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades14[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades15.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades15[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades15[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades16.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades16[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades16[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades17.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades17[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades17[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades18.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades18[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades18[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades19.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades19[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades19[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades20.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades20[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades20[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades21.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades21[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades21[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades22.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades22[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades22[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades23.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades23[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades23[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades24.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades24[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades24[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades25.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades25[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades25[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades26.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades26[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades26[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades27.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades27[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades27[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades28.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades28[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades28[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades29.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades29[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades29[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades30.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades30[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades30[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades31.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades31[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades31[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades32.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades32[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades32[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades33.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades33[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades33[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades34.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades34[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades34[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades35.length; i++) {
      googleTrends.interestByRegion({keyword:Necesidades.Necesidades35[i],geo:"MX",hl:"es-419",resolution:"CITY"})
        .then( s => {
          let records = JSON.parse(s).default.geoMapData
          records.map( r => {
            let insert =  `INSERT INTO InteresPorCiudadNecesidad (Ciudad,Necesidad,Valor,Semana,Anio) VALUES ('${r.geoName}','${Necesidades.Necesidades35[i]}',${r.value[0]},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
