    ...
    for(let i=0; i<Necesidades.Necesidades0.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades0[i],geo:"MX",hl:"es-419"})
        .then( s => {
          ...
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades0[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
    ...
    for(let i=0; i<Necesidades.Necesidades1.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades1[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades1[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades2.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades2[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades2[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades3.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades3[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades3[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades4.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades4[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades4[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades5.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades5[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades5[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades6.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades6[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades6[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades7.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades7[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades7[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades8.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades8[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades8[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades9.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades9[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades9[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades10.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades10[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades10[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades11.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades11[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades11[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades12.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades12[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades12[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades13.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades13[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades13[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades14.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades14[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades14[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades15.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades15[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades15[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades16.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades16[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades16[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades17.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades17[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades17[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades18.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades18[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades18[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades19.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades19[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades19[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades20.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades20[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades20[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades21.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades21[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades21[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades22.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades22[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades22[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades23.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades23[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades23[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades24.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades24[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades24[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades25.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades25[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades25[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades26.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades26[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades26[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades27.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades27[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades27[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades28.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades28[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades28[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades29.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades29[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades29[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades30.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades30[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades30[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades31.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades31[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades31[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades32.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades32[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades32[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades33.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades33[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades33[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades34.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades34[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades34[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
    ...
    for(let i=0; i<Necesidades.Necesidades35.length; i++) {
      googleTrends.relatedQueries({keyword:Necesidades.Necesidades35[i],geo:"MX",hl:"es-419"})
        .then( s => {
          let records = JSON.parse(s).default.rankedList[0].rankedKeyword
          records.map( r => {
            let insert =  `INSERT INTO RQNecesidad (BusquedaRelacionada,Necesidad,Valor,Semana,Anio) VALUES ('${r.query}','${Necesidades.Necesidades35[i]}',${r.value},${weekNumber()},${new Date().getFullYear()})`
            connection.query(insert, (error,rows) => error ? console.log(error,"ERROR") : console.log(rows,"DONE"))
            })
          })
        .catch( e => res.status(400).json("BAD",e) )
